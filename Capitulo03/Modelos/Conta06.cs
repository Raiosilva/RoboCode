...
namespace Capitulo03.Modelos
{
    class Conta06
    {
        ...
        public Conta06(string nomeTitular)
        {
        ...
        public Conta06(string nomeTitular, bool especial) : this(nomeTitular)
        {
            Console.WriteLine("Primeiro Construtor");
        ...
        public Conta06(string nomeTitular, bool especial, float limite) : this(nomeTitular, especial)
        {
            Console.WriteLine("Primeiro Construtor");
